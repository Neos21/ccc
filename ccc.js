(function(global, factory) {
  ...
  function ccc(arg1, arg2, arg3) {
    if(arg1 && !arg2 && !arg3) {
      // One Argument
      if(typeof arg1 === 'string' && isColourCode(arg1)) {
        // Colour Code
        const parsed = beautifyColourCode(arg1);
        return colourCodeToRGBCode(parsed);
      }
      else if(isRGBCode(arg1)) {
        // RGB Code
        const parsed = beautifyRGBCode(arg1);
        return rgbCodeToColourCode(parsed);
      }
    }
    else if(arg1 && arg2 && arg3 && isRGBCode(arg1, arg2, arg3)) {
      // Three Arguments : RGB Code
      const parsed = beautifyRGBCode(arg1, arg2, arg3);
      return rgbCodeToColourCode(parsed);
    }
